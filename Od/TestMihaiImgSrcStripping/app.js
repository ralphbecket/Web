...
var Test;
(function (Test) {
    var showingImg = Obs.of(true);
    Test.view = Od.component("view", function () { return Od.DIV([
        Od.BUTTON({ onclick: function () { showingImg(!showingImg()); } }, "Click to toggle the IMG element."),
